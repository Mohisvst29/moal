                      ...
                      <div className="space-y-4">
                        ...
                        <div className="mt-4">
                          <div className="flex justify-between items-center mb-3">
                            <h5 className="text-sm font-semibold">أحجام الصنف</h5>
                            <button
                              onClick={addSize}
                          ...
                          {itemSizes.length === 0 ? (
                            <div className="text-gray-500 text-xs bg-gray-50 p-3 rounded">
                              لا توجد أحجام مضافة
                            </div>
                          ) : (
                            <div className="space-y-2">
                              {itemSizes.map((size, index) => (
                                <div key={index} className="flex gap-2 items-center">
                                  ...
                                  <input
                                    ...
                                    onChange={(e) => updateSize(index, 'price', parseFloat(e.target.value))}
                                    placeholder="السعر"
                                    className="w-16 px-2 py-1 border border-gray-300 rounded text-sm focus:outline-none focus:ring-1 focus:ring-amber-500"
                                  />
                                  <button
                                    onClick={() => removeSize(index)}
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            {item.new && <span className="text-green-500">🆕</span>}
                            {!item.available && <span className="text-red-500">❌</span>}
                          </div>
                        </div>
                        {section && (
                        ...
                        {item.sizes && item.sizes.length > 0 && (
                          <div className="mb-3">
                            <h5 className="text-sm font-semibold mb-2">الأحجام المتاحة:</h5>
                            <div className="space-y-1">
                              {item.sizes.map((size, index) => (
                                <div key={index} className="flex justify-between text-sm bg-gray-50 px-2 py-1 rounded">
                                  <span>{size.size}</span>
                                  <span className="font-medium">{size.price} ريال</span>
                                </div>
                              ))}
                            </div>
                          </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-amber-500"
                      placeholder="مثال: نهاية الأسبوع"
                    />
                  </div>
                  <div className="md:col-span-2">
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                ...
                <div key={offer.id} className="bg-white p-6 rounded-lg shadow-md">
                  {editingOffer?.id === offer.id ? (
                    <div className="space-y-4">
                      ...
                      <input
                        type="number"
                        value={editingOffer.calories || ''}
                        onChange={(e) => setEditingOffer({ ...editingOffer, calories: e.target.value ? parseInt(e.target.value) : undefined })}
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-amber-500"
                        placeholder="السعرات الحرارية"
                      />
                      <label className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500 mb-3">صالح حتى: {offer.valid_until}</p>
                      <div className="flex gap-2">
                        <button
